...
const pb_field_t dfu_init_command_fields[13] = {
    ...
    PB_FIELD( 11, STRING  , REQUIRED, STATIC  , OTHER, dfu_init_command_t, company, boot_validation, 0),
    PB_FIELD( 12, STRING  , REQUIRED, STATIC  , OTHER, dfu_init_command_t, model_name, company, 0),
    PB_LAST_FIELD
};
